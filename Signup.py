...
class Signup:
    ...
    def __init__(self):
        ...
        # Signup button
        self.newaccbutt = Button(self.frame, width=10, text='Sign Up', font=('Segoe UI Black', 16), bd=0, bg='#d6d4d4', command=lambda: self.connect_database(self.UsernameEntry.get()))
    ...
    def connect_database(self, username):
